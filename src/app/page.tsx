...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>Desenvolvendo Post Page Acessível</title>
      </Head>
      <header className={styles.header}>
        <Image src={logoImg} width={286 / 2} alt='Blog da Rocketseat' />

        <nav className={styles.nav}>
          <a href='https://github.com/tsantosadm' aria-label='Acesso Github'>
      ...
      <main>
        <article className={styles.content}>
          ...
          <h3>O que é accessibilidade, afinal?</h3>
        </article>
      </main>
          ...
          <Dialog.Root>
            ...
            <Dialog.Portal>
              ...
              <Dialog.Content className={styles.modal}>
                ...
                <Dialog.Close className={styles.closeModalButton} asChild>
                  <button>
                    Fechar
                  </button>
                </Dialog.Close>
